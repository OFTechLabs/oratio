...
var percentage_handler = function handler(percentage, msg) {
    if (0 == percentage) {
        ...
        fs.readFile("./dist/index.d.ts", (err, data) => {
            ...
            dataString = dataString.replace("// Generated by dts-bundle v0.7.2","// Generated by dts-bundle v0.7.2\n\ndeclare namespace oratio {\n")
            dataString += "}\n\n"
            dataString += "declare module \"oratio\" {\n"
            dataString += "\texport = oratio;\n"
            dataString += "}\n"
